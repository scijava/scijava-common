 ...
 * it is just shorter to type.  See {@link org.scijava.event.bushe.EventServiceLocator} for details on how to customize
...
class EventBus {
  ...
  /**
   ...
   /** @see org.scijava.event.bushe.EventService#getDefaultCacheSizePerClassOrTopic() */
   ...
   /** @see org.scijava.event.bushe.EventService#clearCache() */
