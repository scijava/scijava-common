 ...
 * <p>
 * See the
 * <a href="../../../../overview-summary.html#overview_description">overview</a>
 * for an general introduction and <a href="package-summary.html">package
 * documentation</a> for usage details and examples.
 * </p>
 * <p>
...
interface EventService {
	 ...
	 * type. Only a <b>WeakReference</b> to the subscriber is held by the
	 * EventService.
	 * <p>
	 ...
	 * matching a type. Only a <b>WeakReference</b> to the subscriber is held by
	 * the EventService.
	 * <p>
	 * Subscription is weak by default to avoid having to call unsubscribe(), and
	 * to avoid the memory leaks that would occur if unsubscribe was not called.
	 ...
	 * a <b>WeakReference</b> to the subscriber is held by the EventService.
	 * <p>
	 * Subscription is weak by default to avoid having to call unsubscribe(), and
	 * to avoid the memory leaks that would occur if unsubscribe was not called.
	 * The service will respect the WeakReference semantics. In other words, if
	 ...
	 * that match a RegEx Pattern. Only a <b>WeakReference</b> to the subscriber
	 ...
	 * Only a <b>WeakReference</b> to the VetoEventListener is held by the
	 * EventService.
	 * <p>
	 ...
	 * a <b>WeakReference</b> to the VetoEventListener is held by the
	 * EventService.
	 * <p>
	 * Use this method to avoid having to call unsubscribe(), though with care
	 * since garbage collection semantics is indeterminate. The service will
	 ...
	 * RegEx Pattern. Only a <b>WeakReference</b> to the VetoEventListener is held
	 * by the EventService.
	 *
